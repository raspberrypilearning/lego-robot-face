...
Now that you know which objects will trigger which responses, you need to build a robotic face with which to animate the expressions. In this step, we're going to walk you through an example model, but you can adapt the plan depending on what you have available.
